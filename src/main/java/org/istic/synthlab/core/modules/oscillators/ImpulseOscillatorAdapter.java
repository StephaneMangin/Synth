...
public class ImpulseOscillatorAdapter extends AbstractOscillator {
    ...
    public ImpulseOscillatorAdapter(IComponent component) {
        ...
        this.frequencyPotentiometer = new Potentiometer("Frequency", PotentiometerType.EXPONENTIAL, impulseOscillator.frequency, ValueType.FREQUENCY, 20000.0, 20.0, 320.0);
